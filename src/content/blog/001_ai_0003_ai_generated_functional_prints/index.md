...
![title](/blog/001_ai_0003_ai_generated_functional_prints/title.jpg)
...
1. The Github folder also includes the Blender Add On, so open Blender, and go to Edit -> Preferences -> Add On (Tab), and then install for local desk : 
   ![image-20251123104410887](/blog/001_ai_0003_ai_generated_functional_prints/image-20251123104410887.png)
...
3. Now all you need to do is connect to MCP by enableing "Connect To Server" like below, this will start blender to listen on the MCP port : 
   ![image-20251123104614713](/blog/001_ai_0003_ai_generated_functional_prints/image-20251123104614713.png)

**Antigravity**

1. under Agent manager, click on MCP server : 
   ![image-20251123103231388](/blog/001_ai_0003_ai_generated_functional_prints/image-20251123103231388.png)

2. Then Manage MCP Servers -> View raw config.
   ![image-20251123103317926](/blog/001_ai_0003_ai_generated_functional_prints/image-20251123103317926.png)
...
![blender_mcp_1 Large](/blog/001_ai_0003_ai_generated_functional_prints/blender_mcp_1_Large.jpeg)

![blender_mcp_2 Large](/blog/001_ai_0003_ai_generated_functional_prints/blender_mcp_2_Large.jpeg)

![blender_mcp_3 Large](/blog/001_ai_0003_ai_generated_functional_prints/blender_mcp_3_Large.jpeg)
...
4. Then in the 3d Printer Slicer, Bambulab in my case, you can import .stl : 
   ![blender_mcp_4](/blog/001_ai_0003_ai_generated_functional_prints/blender_mcp_4.png)

5. Printinggg !
   ![video_2025-11-20_03-31-34](/blog/001_ai_0003_ai_generated_functional_prints/video_2025-11-20_03-31-34.gif)

6. And now I have an AI generated Koffee Dripper :

   
   ![IMG_4843 2 Large](/blog/001_ai_0003_ai_generated_functional_prints/print_1.jpeg)
   
   ![IMG_4844 Large](/blog/001_ai_0003_ai_generated_functional_prints/print_2.jpeg)
